...
/** Standard mIRC/HexChat-compatible palette: classic 16 colors plus 83 extended swatches. */
internal val MircPaletteArgb = intArrayOf(
...
internal fun mircPaletteColor(code: Int): Color =
    Color(0xFF000000L or MircPaletteArgb[code.coerceIn(MircPaletteArgb.indices)].toLong())
