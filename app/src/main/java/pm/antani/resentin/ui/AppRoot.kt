    ...
    NavHost(
        ...
        composable(
            ...
            val viewModel: NetworkSettingsViewModel = viewModel(
                ...
                factory = NetworkSettingsViewModel.factory(container.networksRepository, container.ignoresRepository, container.userSettingsRepository, appContext, networkSlug),
            )
